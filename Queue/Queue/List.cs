...
namespace Queue
{
    public class List<T>
    {
        ...
        public void AddLast(T value)    //Add a node to the end of the list
        {
            count++;
        ...
        public void AddBefore(int index, T value)  //Add a node with the given value before the given index
        {
            count++;
        ...
        public void AddAfter(int index, T value)   //Add a node with the given value after the given index
        {
            count++;
