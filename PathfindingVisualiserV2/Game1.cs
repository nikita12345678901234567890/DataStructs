...
namespace PathfindingVisualiserV2
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                lines.Clear();
                var path = Astar(start.ToPoint(), end.ToPoint(), allowDiagonals);
        ...
        {
            return new Point((int)indexX * (grid[0, 0].HitBox.Width + 0) + 2, (int)indexY * (grid[0, 0].HitBox.Height + 0) + 2);
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawLine(line.Start, line.End, Color.Yellow, 3);
            }
